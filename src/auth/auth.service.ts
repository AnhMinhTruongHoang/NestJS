...
export class AuthService {
  ...
  async validateGoogleUser(
    ...
    const newUser = await this.usersService.createFromGoogle({
      ...
      name: googleUser.name ?? 'Google User', // default nếu không có name
  ...
  //////////////
  async loginWithGoogle(googleUser: LoginWithGoogleDto, res: Response) {
    const user = await this.validateGoogleUser(
      googleUser,
      this.configService.get<string>('DEFAULT_USER_ROLE_ID'), // role mặc định
    );
